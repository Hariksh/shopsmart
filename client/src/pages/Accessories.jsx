...
import { ShoppingCart, Star, Heart, Glasses, Watch, Gem, Smartphone, Loader2, PackageX , Check} from 'lucide-react';
                                ...
                                >
                                    ...
                                    <div className="p-6 flex flex-col grow">
                                        ...
                                        <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-50">
                                            ...
                                            className={`${"flex items-center justify-center p-3 bg-purple-50 rounded-full text-purple-600 hover:bg-purple-500 hover:text-white transition-all group-hover:shadow-md"} ${(addedProductId === (typeof product !== 'undefined' ? (product._id || product.id) : (item._id || item.id))) ? '!bg-green-500 !text-white' : ''}`}
                                        >
