                                ...
                                <div className="p-5">
                                    ...
                                    <div className="flex items-center justify-between mt-auto">
                                        ...
                                        <button
                                            ...
                                            className={`${"p-2.5 bg-blue-50 rounded-xl text-blue-600 hover:bg-blue-600 hover:text-white transition-all transform hover:scale-105"} ${(addedProductId === (product._id || product.id)) ? '!bg-green-500 !text-white' : ''}`}
                                        >
